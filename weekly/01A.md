...
- Major HW assignments:
  - Technobabble! (Media Queries, load local JSON via `fetch()` API, arrow functions, ES6 modules)
  - Audio Visualizer (canvas & web audio API)
  - Web App "refactor" (convert a pre-existing project to ES6/TypeScript and use a Node.js build tool)
  - NY State Park Buddy (Bulma CSS framework, Mapbox, `localStorage`, Firebase for remote storage of analytics)
...
| --- | --- | --- 
|   :-\  |  [**IGME-330 Schedule**](../schedule.md) | [**Week 1B Notes**](02A.md)
