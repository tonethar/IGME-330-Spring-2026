...
- [IGME-330 class code standards](../notes/code-style-required-330.md)
...
### IV-B. Better data file

- Let's work on parsing and displaying the contents of this JSON file, which has some extra information (in nested objects) in it about the pet names:
...
- Read --> [ES6 Module Notes](https://github.com/tonethar/IGME-330-Master/blob/master/notes/ES6-module-pattern-2225.md)
...
- Something to keep in mind, ES6 modules (similar to classes and OOP practices) are "for people/programmers" - and NOT for the computer
  ...
  - code organization, modules, OOP etc are there solely to help developers write better code with fewer bugs, and to more easily maintain/update it
