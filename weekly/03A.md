...
- Let's work on parsing this JSON file, which has some extra information (in nested objects) in it about our pet names:
...
### III-C. Filtering results with `Array.filter()`
