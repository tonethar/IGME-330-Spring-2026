...
- ***YOU DO -->*** write `// Wall Collisions (Left/Right)` so that we have collisions working for everything (except the bottom of the screen)
- Bring it to class completed and ready to go next time, we'll be adding bricks, ball/bick collisions, scoring and sound
